...
import cz.istep.javatest.model_serializer.FrameworkParentDeserializer;
import cz.istep.javatest.model_serializer.FrameworkParentItemSerializer;
...
public class JavaScriptFramework {
	...
	//@JsonSerialize(using = FrameworkParentItem.class)
	//@JsonDeserialize(using = FrameworkParentDeserializer.class)
	...
	public JavaScriptFramework(String name, int versionOrder) {
		this.name = name;		
