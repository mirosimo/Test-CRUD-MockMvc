...
public class JavaScriptFrameworkTests {
	...
	public void prepareData() throws Exception {
		...
		JavaScriptFramework root = new JavaScriptFramework("root", null, 0);		
			JavaScriptFramework reactV1 = new JavaScriptFramework("React ver 1.0", root, 1);
			JavaScriptFramework reactV2 = new JavaScriptFramework("React ver 2.0", root, 2);
			JavaScriptFramework reactV3 = new JavaScriptFramework("React ver 3.0", root, 3);
				JavaScriptFramework reactV3_1 = new JavaScriptFramework("React ver 3.1", reactV2, 1);
				JavaScriptFramework reactV3_2 = new JavaScriptFramework("React ver 3.2", reactV2, 2);
				
			JavaScriptFramework vueV1 = new JavaScriptFramework("Vue.js ver 1.0", root, 1);
			JavaScriptFramework vueV2 = new JavaScriptFramework("Vue.js ver 2.0", root, 2);
		
			frameworkService.saveEntity(root);
			frameworkService.saveEntity(reactV1); frameworkService.saveEntity(reactV2); frameworkService.saveEntity(reactV3);
				frameworkService.saveEntity(reactV3_1);frameworkService.saveEntity(reactV3_2);
			frameworkService.saveEntity(vueV1); frameworkService.saveEntity(vueV2);
	}
