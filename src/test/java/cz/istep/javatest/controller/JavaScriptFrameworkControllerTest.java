...
public class JavaScriptFrameworkControllerTest {
	...
	@Test
	@DisplayName("POST /framework-new - Add new Framework - everything OK")
	...
	public void addNotExistParentFramework() throws Exception {
		Long notExistId = this.frameworkService.getMaxId() + 14L;
		...
		.andExpect(jsonPath("$.message", is("Parent entity with id " + parentFramework.getId() + " was not found")));		
	}*/
